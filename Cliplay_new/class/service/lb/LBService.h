...
@interface LBService : NSObject<TencentSessionDelegate, TencentApiInterfaceDelegate, TencentLoginDelegate, WeiboSDKDelegate, AAShareBubblesDelegate, WBHttpRequestDelegate, REComposeViewControllerDelegate, UIAlertViewDelegate>
